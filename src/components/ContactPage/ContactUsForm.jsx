    ...
    >
        ...
        <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
                ...
                className="rounded-lg bg-richblack-700 p-3 text-[16px] leading-[24px] text-richblack-5
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-5">
                <div className="flex w-[101px] flex-col gap-2">
                    ...
                    name="dropdown"
                    id="dropdown"
                    className="rounded-lg bg-richblack-700 p-3 text-[13.2px] leading-[24px] text-richblack-5
                    shadow-[0_1px_0_0] shadow-white/50 placeholder:text-richblack-400 focus:outline-none"
