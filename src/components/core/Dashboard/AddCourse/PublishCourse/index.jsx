...
export default function PublishCourse() {
  ...
  formData.append("category", course.category._id ?? course.category)
  formData.append("tag", JSON.stringify(course.tag))
  formData.append("instructions", JSON.stringify(course.instructions))
        ...
        <div className="ml-auto flex max-w-max items-center gap-x-4">
          ...
          {/* <IconBtn disabled={loading} text="Save Changes" /> */}
           <IconBtn
            type="submit"
            disabled={loading}
            text={ loading ? "Publishing…" : "Save & Publish" }
            />
        </div>
      </form>
    </div>
